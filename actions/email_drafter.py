...
def draft_prospect_email(answers: List[Answer]) -> str:
    ...
    rejected_line = (
        ...
        "team will receive a separate note regarding these items."
        if summary.rejected
        else ""
    )
...
Run summary:
  ...
  - Reviewed and approved by our security team: {summary.human_approved}
  - Policy documents referenced: {source_count}{rejected_line}

Each response references the underlying policy document so your team can trace
every answer back to source material. This audit trail is maintained throughout
our automated pipeline — no claim is generated without a grounded citation.

A signed DPA and our latest SOC 2 Type II report are available under NDA.
Let me know if you'd like either kicked off.
...
---
Generated by TrustLoop — AI-assisted security questionnaire automation
"""
    return body.strip() + "\n"
